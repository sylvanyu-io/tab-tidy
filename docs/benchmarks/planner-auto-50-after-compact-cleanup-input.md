...
Generated: 2026-06-26T20:46:56.892Z
...
- Raw data: `docs/benchmarks/data/planner-scale-2026-06-26T20-46-42-735Z-pid28284.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Task bursts with natural tab order | 50 | product default auto route | hierarchical | ok | 14.1s | 2 | 15348 | 38.0 KB | 11 | 50 | 0 | ok |

## Takeaways

- Task bursts with natural tab order, 50 tabs: auto used hierarchical and completed successfully in 14.1s with 2 request(s).
