...
Generated: 2026-06-26T06:47:23.686Z
...
- Raw data: `docs/benchmarks/data/planner-scale-2026-06-26T06-45-15-751Z.json`

## Results

| Tabs | Strategy | Status | Time | Requests | Groups | Grouped Tabs | Review Tabs | Validation |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 50 | current hierarchical coarse/refine | ok | 58.3s | 2 | 10 | 50 | 0 | ok |
| 120 | current hierarchical coarse/refine | ok | 69.7s | 2 | 12 | 120 | 0 | ok |

## Takeaways

- 50 tabs: hierarchical completed successfully in 58.3s with 2 request(s).
- 120 tabs: hierarchical completed successfully in 69.7s with 2 request(s).
