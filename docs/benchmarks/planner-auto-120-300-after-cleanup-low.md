...
Generated: 2026-06-26T20:54:11.512Z
...
- Raw data: `docs/benchmarks/data/planner-scale-2026-06-26T20-52-24-931Z-pid36868.json`
...
| --- | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| Task bursts with natural tab order | 120 | product default auto route | hierarchical | ok | 36.6s | 2 | 48719 | 63.2 KB | 10 | 120 | 0 | ok |
| Task bursts with natural tab order | 300 | product default auto route | hierarchical | ok | 69.9s | 3 | 81578 | 150.1 KB | 12 | 298 | 2 | ok |

## Takeaways

- Task bursts with natural tab order, 120 tabs: auto used hierarchical and completed successfully in 36.6s with 2 request(s).
- Task bursts with natural tab order, 300 tabs: auto used hierarchical and completed successfully in 69.9s with 3 request(s).
