...
Generated: 2026-06-26T06:31:10.674Z
...
- Raw data: `docs/benchmarks/data/planner-scale-2026-06-26T06-31-09-684Z.json`

## Results

| Tabs | Strategy | Status | Time | Requests | Groups | Grouped Tabs | Review Tabs | Validation |
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 50 | current hierarchical coarse/refine | failed | 0.9s | 1 | - | - | - | 默认 AI 服务这次没有成功完成。请稍后再试，或在更多选项里临时切换自定义 AI 网关。 |
| 120 | current hierarchical coarse/refine | failed | 0.1s | 1 | - | - | - | 默认 AI 服务这次没有成功完成。请稍后再试，或在更多选项里临时切换自定义 AI 网关。 |

## Takeaways

- 50 tabs: hierarchical completed with failure in 0.9s with 1 request(s).
