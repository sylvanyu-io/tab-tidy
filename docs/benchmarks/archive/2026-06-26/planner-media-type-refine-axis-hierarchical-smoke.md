...
Generated: 2026-06-26T08:15:48.293Z
...
- Raw data: `docs/benchmarks/data/planner-scale-2026-06-26T08-15-10-417Z.json`
...
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| Media type preference | 120 | current hierarchical coarse/refine | ok | 37.9s | 3 | 10 | 120 | 0 | ok |

## Takeaways

- 120 tabs: hierarchical completed successfully in 37.9s with 3 request(s).
