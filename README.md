...
它支持当前窗口整理、所有窗口合并到一个窗口、整理前预览、应用后回退，以及基于本地标签页活动的时间段回顾。
...
<p align="center">
  <img src="docs/assets/readme-hero-cn.png" width="920" alt="TabRecap 中文产品截图" />
</p>
...
AI 只负责给出分组和清理建议。真正移动、分组或关闭标签页前，扩展会在本地校验方案；关闭标签页只会发生在你手动点击之后。
...
- **大规模任务规划**：一次读取完整标签页清单，同时生成分组建议和清理建议。
- **时间回顾**：按今天、最近 7 天、最近 30 天或自定义时间范围，回顾自己主要在看什么、做什么。
- **清理建议**：AI 会标出可能过期、重复或已经完成的标签页；只在你手动点击后才会关闭。
